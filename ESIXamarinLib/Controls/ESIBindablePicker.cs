...
namespace ESIXamarinLib.Controls
{
    public class ESIBindablePicker : Picker
    {
        ...
        static void OnItemsSourceChanged(BindableObject bindable, Object oldValue, Object newValue)
        {
            ...
            var picker = (ESIBindablePicker)bindable;
            if (picker != null)
            {
        ...
        {
            var boundPicker = (ESIBindablePicker)bindable;
            boundPicker.ItemSelected?.Invoke(boundPicker, new SelectedItemChangedEventArgs(boundPicker.SelectedItem, boundPicker.SelectedIndex));
